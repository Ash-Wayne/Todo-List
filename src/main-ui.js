...
import { eventListenerReferences, getProjectsLoadedFromDatabase } from './index.js';
...
export function addNewProject(projectName) {
	...
	for (let project of getProjectsLoadedFromDatabase()) {
...
export function setupAddNewProjectListener() {
...
function isProjectNotInDatabase(projectName) {
	if (getProjectsLoadedFromDatabase().length === 0) return true;
